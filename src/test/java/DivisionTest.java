...
public class DivisionTest extends TestCase
{
    ...
    public DivisionTest(String operand1, String operand2,char operation, String result)
    {
    ...
    { if (operation == '/')
    {
        ...
        if(isParseOperand1 &&
            ...
            double result = Arithmetic.division(Double.parseDouble(operand1),Double.parseDouble(operand2));
