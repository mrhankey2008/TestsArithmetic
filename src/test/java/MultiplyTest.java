...
public class MultiplyTest extends TestCase
{
    ...
    public MultiplyTest(String operand1, String operand2,char operation, String result)
    {
    ...
    public void multiplyTest() throws  Exception
    {
        if (operation == '*')
        {
            ...
            if(isParseOperand1 &&
                ...
                double result = Arithmetic.multiply(Double.parseDouble(operand1),Double.parseDouble(operand2));
