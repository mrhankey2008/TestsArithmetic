...
public class SumTest extends TestCase
{
    ...
    public SumTest(String operand1, String operand2,char operation,  String result)
    {
    ...
    public void sumTest() throws  Exception
    {
        if (operation == '+')
        {
            ...
            if(isParseOperand1 &&
                ...
                double result = Arithmetic.sum(Double.parseDouble(operand1),Double.parseDouble(operand2));
